...
}`},{method:`GET`,path:`/provinces/{province_id}.json`,description:`Kepoin satu provinsi aja by kode — misal 32 = Jawa Barat (level 1)`,curl:`curl ${I}/provinces/32.json`,snippets:{curl:`curl ${I}/provinces/32.json`,fetch:`const res = await fetch("${I}/provinces/32.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
  "${I}/provinces/32.json"
